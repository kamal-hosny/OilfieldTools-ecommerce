...
import { Link } from 'react-router-dom'; // أو أي مكتبة توجيه تستخدمها
    ...
    <div className="">
      <ul className="flex gap-2 text-xs text-color-text-2 items-center">
        {items.map((item, index) => (
          <>
          <li key={index} className="cursor-pointer p-2 rounded-md transition-all hover:text-color-text-1 duration-300 flex gap-2">
